...
public class T08_check_item_status {
    ...
    public void TC02_addItems() {
        ...
        Response resp = RestAssured.given().
                ...
                extract().
                response();
        mediaid = resp.path("results[0].media_id");
    }

    @Test
    public void TC03_check_item_status() {
        RestAssured.
                given().
                auth().
                oauth2(write_access_token).
                get(url.setupURL() + "/" + id + "/item_status?media_id=" + mediaid + "&media_type=movie").
                then().
                assertThat().
                statusCode(200).
                body("status_message", equalTo("Success.")).
